...
class website(osv.osv):
    ...
    def new_page(self, cr, uid, name, template='website.default_page', ispage=True, context=None):
        ...
        # logger.info("\nwebsite-195-new_page:\n name = {%s}\n page_name = {%s}\n page_xmlid = {%s}\n", name, page_name, page_xmlid)

        try:
            # existing page

            # logger.info("\nwebsite-201-new_page:\n template_module = {%s}\n page_name = {%s}\n", template_module, page_name)
            ...
            # logger.info("\nwebsite-209-new_page:\ntemplate_name={%s}\ntemplate_id={%s}\npage_id={%s}\npage={%r}\n",\
            #                                                                  template_name,template_id,page_id,page)
    ...
    def copy_page(self, cr, uid, name, current_page, ispage=True, context=None):
        ...
        try:
            # For coppied page, it should have been exist in database.
            imd.get_object_reference(cr, uid, template_module, page_name)
